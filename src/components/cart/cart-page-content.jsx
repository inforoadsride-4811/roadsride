...
import { Minus, Plus, Trash2, Shield, Truck, RotateCcw, Loader2 } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 md:py-12">
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          <div className="flex-1 space-y-4">
            {[1, 2].map((i) => (
              <div key={i} className="bg-white border border-brand-border rounded-xl p-6 flex gap-4 animate-pulse">
          ...
          <div className="w-full lg:w-80 xl:w-96">
            <div className="bg-white border border-brand-border rounded-xl p-6 animate-pulse space-y-4">
